...
- `cd backend && ../mvnw test` with Java 21 — 21 passed, 0 failures, 0 errors
- `cd backend && ../mvnw javadoc:javadoc` — passed
- `git diff --check` — passed

Backend coverage includes cooking-code identity matching and immutability, full meal editing,
duplicate-name rejection, random eligibility, atomic consumption and undo, cooking-code and
